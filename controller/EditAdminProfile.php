  ...
  <body>
    ...
    <section id="container" class="">
      ...
      <header class="header dark-bg">
        ...
        <!--logo start-->
        <a href="../dashboard/coordinator.php" class="logo"><span class="lite"> Students' Systems Project Management System. </span></a>
        <!--logo end-->
        ...
        <section id="main-content">
          <section class="wrapper">
            <div class="row">
              <div class="col-lg-12">
                <h3 class="page-header"><i class="icon_profile"></i>Edit Profile </h3>
                <ol class="breadcrumb">
                  <li><i class="fa fa-home"></i><a href="../dashboard/coordinator.php">Home</a></li>
                </ol>
              </div>
            </div>
            <div class="row">
                    ...
                    <div class="panel-body">
                      <form class="form-horizantal" action="../include/server.php" method="post">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="col-md-6">
                              <button type="submit" class="btn btn-primary" name="reg_user" value="register1"> Update </button>
                            </div>
                          </div>
                        </div>
                      </form>
