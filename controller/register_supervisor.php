                  ...
                  <section class="panel">
                    <div class="panel-body">
                      <form class="form-horizantal" action="../include/server.php" method="post">
                        <div class="row">
                          <div class="col-lg-6">
                            <label class="col-md-6"> Lecture Name </label>
                            <input type="text" name="lecturer_name" class="form-control" pattern="[A-Za-z']+">
                          </div>
                          <div class="col-lg-6">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            ...
                            <input type="text" name="username" class="form-control" pattern="[A-Za-z']+">
                          </div>
                          <div class="col-lg-6">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="col-md-6">
                              <button type="submit" class="btn btn-primary" name="register2" value="register2"> Register </button>
                            </div>
                          </div>
                        </div>
                      </form>
