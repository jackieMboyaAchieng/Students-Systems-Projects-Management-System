        ...
        <aside>
          <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                <a class="" href="../controller/project_details.php">
              ...
              <li class="sub-menu">
                ...
                <ul class="sub">
                  <li><a class="" href="../controller/journal.php"> Project Journal </a></li>
          ...
          <section class="wrapper">
            ...
            <div class="row">
              <div class="">
                ...
                <ol class="breadcrumb">
                  <li><i class="fa fa-home" style="text-align: center;"></i><a href="../dashboard/student.php"> Journal </a></li>
                </ol>
              </div>
            </div>
            <div class="col-md-9">
              <div class="table">
                ...
                $db = new DBconnect();
                $conn=$db->connect();
                $query=$conn->prepare("select * from journal ");
                $query->execute([]);
                if($query->rowCount() > 0){
                echo "<table>
                          <tr>
