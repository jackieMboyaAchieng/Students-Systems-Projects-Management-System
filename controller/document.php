            ...
            <div class="row">
              ...
              <form>
                <table class="table table-bordered table-striped table-hover" style="margin-left: 9px;" id="table">
                  ...
                  $query=$conn->prepare("select document_id, student_reg_no, document_name, review_date, file_name, comments from review");
                  $query->execute([]);
                  if($query ->rowCount() > 0 ){
                  ...
                  echo "<tr>
                    ...
                    <td>".$row['file_name']."</td>
                    <td>".$row['comments']."</td>
                    <td><button type='button' class='btn btn-success'><a href='../Project/Project Proposal document.docx?id=".$row['document_id']."'>Download</a></button></td>
