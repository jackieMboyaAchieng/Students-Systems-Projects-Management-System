            ...
            <div class="table">
              ...
              <table class="table table-bordered table-striped table-hover" style="margin-left: 9px;" id="table">
                ...
                <tbody>
                  ...
                  //echo "hello there".$_SESSION['lecturer_name'];
                 ...
                 // $my_query = "  select project_document.document_id, project_document.student_reg_no, project_document.document_name, project_document.file_name, project_document.submission_date FROM project_document JOIN users ON users.lecturer_username=3458";
                  ...
                  $query=$conn->prepare("select document_id, student_reg_no, document_name, file_name, review_date from review where username = $lecturer_name");
                  $query->execute([]);
                  if($query ->rowCount() > 0 ){
